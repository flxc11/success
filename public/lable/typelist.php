...
if (isset($modulesid) && $modulesid == TRUE) {
	...
	$modules[$i]['desc'] = '用于内容分类列表显示（产品、新闻等），<a class="infolink05" target="_blank" href="http://www.cnvp.com.cn/chm/typelist.html">点击参考标签说明</a>，<a class="infolink05" target="_blank" href="http://www.cnvp.com.cn/chm/k6.html">点击参数分类字段说明</a>';
	$modules[$i]['lng'] = '1';
	$modules[$i]['mid'] = '1';
	$modules[$i]['sid'] = '0';
	$modules[$i]['tid'] = '1';
