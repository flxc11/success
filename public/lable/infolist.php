...
if (isset($modulesid) && $modulesid == TRUE) {
	...
	$modules[$i]['desc'] = '用于所有内容的输出（如文章、新闻、产品等），<a class="infolink05" target="_blank" href="http://www.cnvp.com.cn/chm/k15.html">点击参考标签说明</a>，<a class="infolink05" target="_blank" href="http://www.cnvp.com.cn/chm/k7.html">点击参数内容字段说明</a>';
	$modules[$i]['lng'] = '1';
	$modules[$i]['mid'] = '1';
	$modules[$i]['sid'] = '1';
	$modules[$i]['tid'] = '1';
	...
	$modules[$i]['config'] = array(
	    ...
	    array('botname' => '标题字符数', 'name' => 'm7', 'type' => 'text', 'value' => '0', 'str' => '可选项，如果为0或空，则表示显示全部标题字符！需相关函数支持，<a class="infolink05" target="_blank" href="http://www.cnvp.com.cn/chm/k10.html">点击参考</a>'),
	    array('botname' => '显示日期格式', 'name' => 'm8', 'type' => 'select', 'value' => '0', 'str' => '需相关函数支持，<a class="infolink05" target="_blank" href="http://www.cnvp.com.cn/chm/k11.html">点击参考</a>',
		'sevalue' => array(
