...
if (isset($modulesid) && $modulesid == TRUE) {
	...
	$modules[$i]['desc'] = '用于flash幻灯片、友情链接、文字链等广告形式的内容输出，<a class="infolink05" target="_blank" href="http://www.cnvp.com.cn/chm/k16.html">点击参考标签说明</a>，<a class="infolink05" target="_blank" href="http://www.cnvp.com.cn/chm/k7.html">点击参数内容字段说明</a>';
	$modules[$i]['lng'] = '1';
	$modules[$i]['mid'] = '1';
	$modules[$i]['sid'] = '0';
	$modules[$i]['tid'] = '1';
