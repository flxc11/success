...
class dbmysql {
	...
	function halt($message = '', $sql = '') {
		...
		$mysqlinfo = '<font size="2"><br/><b>JCMS SQL Error:</b> Can not connect to MySQL server<br/><b>Time:</b>' . date('e Y-m-d H-i-s', time());
		$mysqlinfo.= $db_sql ? '<br/><b>SQL:</b>' . $sql : '';
		$mysqlinfo.= $db_err ? '<br/><b>Error：</b>' . mysql_error() : '';
		$mysqlinfo.= '<br/><a target="_blank" href="http://www.JCMS.com">http://www.JCMS.com</a> Access Query Errors</font>';
		exit($mysqlinfo);
	}
