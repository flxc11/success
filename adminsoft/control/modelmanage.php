...
class important extends connector {
	...
	function onmodelsave() {
		...
		if ($inputclass == 'add') {
			$db_field = 'lng,modelname,pagemax,pagesylte,isclass,lockin,istsn,isbase,addtime,isalbum,isextid,issid,isfgid,islinkdid,isorder,ismessage,ispurview,tsnstyle';
			$db_values = "'$lng','$modelname',$pagemax,$pagesylte,$isclass,0,$istsn,$isbase,$date,$isalbum,$isextid,$issid,$isfgid,$islinkdid,$isorder,$ismessage,$ispurview,'$tsnstyle'";
			...
			isorder=$isorder,ismessage=$ismessage,ispurview=$ispurview,tsnstyle='$tsnstyle'";
			...
			$db_field = 'lng,modelname,pagemax,pagesylte,isclass,lockin,istsn,isbase,addtime,isalbum,isextid,issid,isfgid,islinkdid,tsnstyle';
			$db_values = "'$lng','$modelname',$pagemax,$pagesylte,$isclass,0,$istsn,$isbase,$date,$isalbum,$isextid,$issid,$isfgid,$islinkdid,'$tsnstyle'";
			$this->db->query('INSERT INTO ' . $db_table . ' (' . $db_field . ') VALUES (' . $db_values . ')');
